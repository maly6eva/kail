    ...
    return (
        <>
            <div className={c.content}>
                <img className={c.imge} src="https://silverbeard.ru/wp-content/uploads/2018/09/Obruchalnye-koltsa-Volna-i-Gora.jpg" alt={'Photo'}/>
